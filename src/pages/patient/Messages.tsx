  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-neutral-500 mt-1">Secure communication with your care team</p>
      </div>
              ...
              threads.map(thread => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className={`text-xs truncate ${thread.patientUnreadCount > 0 ? 'text-neutral-900 font-medium' : 'text-neutral-500'}`}>
